<template>
  <div class="flex flex-col h-full">
    ...
    >
      <span class="text-xs font-medium text-[var(--icon-color)]">Game</span>
      <n-select
...
const mapPad1 = (e: KeyboardEvent, key: NesPadKey) => {
  pad1.value = { ...pad1.value, [key]: e.code }
}

const mapPad2 = (e: KeyboardEvent, key: NesPadKey) => {
