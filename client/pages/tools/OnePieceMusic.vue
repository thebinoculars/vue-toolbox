<template>
  <div class="flex flex-col h-full">
    ...
    >
      <span class="text-xs font-medium text-[var(--icon-color)]">Episode</span>
      <n-select
        ...
        <template v-else>
          <div class="md:px-4">
            <n-timeline size="large" :icon-size="28">
              ...
              >
                <template #icon>
                  <n-icon size="24" class="text-[var(--accent-primary)]">
                    <Music />
                  </n-icon>
                </template>
                <template #header>
                  <div class="flex items-center justify-between pb-1">
                    ...
                    >
                      <div
                        ...
                        :class="currentTrackId === item.song?.id ? 'text-indigo-400' : ''"
...
interface OnePieceStamp {
  _id?: string
  time: string
  song?: { id: number; titles: { en: string } }
  album?: { titles: { en: string } }
}
