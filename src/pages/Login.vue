  ...
  <div class="w-full max-w-md px-4">
    <n-card :bordered="false" class="shadow-xl rounded-2xl">
          <div class="text-center mb-8">
            <n-icon size="48" color="#6366f1" class="mb-3"><LockClosedOutline /></n-icon>
          ...
          <n-form @submit.prevent="handleLogin">
            ...
            <n-form-item label="Password">
              <n-input v-model:value="password" type="password" placeholder="Enter your password" size="large" show-password-on="click" />
            </n-form-item>
...
const handleLogin = async () => {
  ...
  try {
    ...
    else if (data?.success) router.push('/')
